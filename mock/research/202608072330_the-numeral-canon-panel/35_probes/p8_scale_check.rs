// p8 scale check: generated by concatenating p8_log2ceil_without_a_table.rs
// (inner attribute hoisted) with capacity rows up to 65536, to find out
// whether the inductive ceil(log2) reaches a realistic capacity at all.
// This is an EXISTENCE check. It says the construction reaches these
// capacities; it says nothing about how long it takes, which is unpriced.
#![allow(dead_code)]
...
// ---- the scale rows ----
pub type P2048 = Twice<P1024>;
pub type P4096 = Twice<P2048>;
pub type P8192 = Twice<P4096>;
pub type P16384 = Twice<P8192>;
pub type P32768 = Twice<P16384>;
pub type P65536 = Twice<P32768>;
// 65535, the all-ones case, which walks the TwiceP1 arm (and therefore the
// increment) at every one of sixteen levels rather than the cheap Twice arm.
pub type P65535 = TwiceP1<
    TwiceP1<
        TwiceP1<
            TwiceP1<
                TwiceP1<
                    TwiceP1<
                        TwiceP1<
                            TwiceP1<
                                TwiceP1<TwiceP1<TwiceP1<TwiceP1<TwiceP1<TwiceP1<TwiceP1<One>>>>>>>,
                            >,
                        >,
                    >,
                >,
