...
// ---- three deliberate errors, one per site class ----------------------------
// class 1: an ordinary coordinate mismatch (already good in 137, unchanged here)
pub fn e1(a: UFixed<13, 3, Hot>) -> UFixed<16, 3, Hot> {
    a
}
// class 2: a width arvo does not ship
pub fn e2(a: Fixed<7, 1, Hot>) -> Fixed<7, 1, Hot> {
    a
}
// class 3: a width-law failure, output 30 where the law gives 26
pub fn e3(a: UFixed<13, 3, Hot>, b: UFixed<13, 3, Hot>) -> Fixed<30, 6, Hot> {
    mul(a, b)
}
