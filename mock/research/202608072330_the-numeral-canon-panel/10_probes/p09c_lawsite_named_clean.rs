//! P09c. Same as P09b with the deliberate mismatch removed: does the correct
//! site still infer OI = 26 and OF = 6 through the named relation? TREATMENT for the law-relation diagnostic, the one site class `137`
