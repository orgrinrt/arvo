//! P11. Can the leaked width table be suppressed? Attempt one:
//! `#[diagnostic::do_not_recommend]` on every bridge impl.
//! (was P10.) The other degraded site: a width outside the shipped bridge. The
