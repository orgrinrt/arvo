//! p2c NEGATIVE CONTROL. p2 with the distinguishability control made false:
//! it asserts the Warm carrier at W = 3 is `u16` where both tables say `u8`.
//! This MUST refuse. Without it the distinguishability arm is a claim nobody
//! showed could fail, and a vacuous table (every objective the same type) would
//! pass the agreement arm while proving nothing.
//!
