...
CAND = "173_leroy_the_canon_candidate_for_the_chain.md"
...
def main():
    ...
    print(f"\nunique line anchors across the 9 sources : {len(src_anchors)}")
    print(f"unique probe paths across the 9 sources  : {len(src_probes)}")
    ...
    print("\n-- controls --")
    pos = "60:28-29" in ca
    print(f"positive control (60:28-29 found in candidate): {'PASS' if pos else 'FAIL'}")
