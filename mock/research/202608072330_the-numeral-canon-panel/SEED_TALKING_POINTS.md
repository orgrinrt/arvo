...
checkpoint recorded the gate as **met**, "and how it was met matters" (`137b:10-26`), where the
how-it-was-met was a derived property (the payload-is-one-limb condition) rather than a discipline,
which op had predicted at `135b:65-68`. Neither fact answers which verb op now means; both are
