...
/// LEAK 4: the same hole, behind a type alias. The instrument's stated false negative,
/// turned into a demonstrated one.
pub type Storage = u16;

impl<const W: usize, S> UFixed<W, S> {
    pub const fn from_storage(raw: Storage) -> Self {
        UFixed {
            raw,
            _s: core::marker::PhantomData,
        }
