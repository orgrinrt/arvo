...
CITES = [
    ...
    ("25:396-399 toolbox-not-policer quote", P25, 396, 399, "knowledge the substrate cannot have"),
    ...
    ("35:728-731 the properties reframing", P35, 728, 731, "which\nproperties the arithmetic has"),
