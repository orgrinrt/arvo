...
def main():
    ...
    print(f"\nunique line anchors across the 13 sources : {len(src_anchors)}")
    print(f"unique probe paths across the 13 sources  : {len(src_probes)}")
    ...
    # CONTROLS
    print("\n-- controls --")
    pos = "112:904-906" in ca
    print(f"positive control (112:904-906 found in candidate): {'PASS' if pos else 'FAIL'}")
