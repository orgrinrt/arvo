...
LBB1_1:
	...
	lsr	x17, x3, x17
	lsr	x1, x4, x5
	and	x15, x15, #0x7ffffff
	and	x16, x16, #0x7ffffff
	and	x17, x17, #0x7ffffff
	and	x1, x1, #0x7ffffff
	add	x8, x15, x8
	add	x9, x16, x9
	add	x10, x17, x10
...
LBB3_1:
	ldp	q4, q5, [x8, #-32]
	ldp	q6, q7, [x8], #64
	bic.4s	v4, #248, lsl #24
	bic.4s	v5, #248, lsl #24
	bic.4s	v6, #248, lsl #24
	bic.4s	v7, #248, lsl #24
	uaddw.2d	v0, v0, v4
	uaddw2.2d	v0, v0, v4
	uaddw.2d	v1, v1, v5
	uaddw2.2d	v1, v1, v5
	...
	mov.d	v1[0], v0[0]
	ldr	q0, [x0, #3968]
	bic.4s	v0, #248, lsl #24
	uaddw.2d	v1, v1, v0
	uaddw2.2d	v0, v1, v0
	ldr	q1, [x0, #3984]
	bic.4s	v1, #248, lsl #24
	uaddw.2d	v0, v0, v1
	uaddw2.2d	v0, v0, v1
	addp.2d	d0, v0
	fmov	x0, d0
