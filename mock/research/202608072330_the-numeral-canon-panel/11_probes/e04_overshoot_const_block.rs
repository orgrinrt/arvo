//! e04. Closing e01's overshoot, following rustc's own two suggestions. An enumeration-free const-to-type bridge, in one blanket impl.
//!
...
// e02: the one line that closes the overshoot. N bits want ceil(N/8) bytes.
pub trait Packed {
    type const B: usize;
    type P;
}
impl<const N: usize> Packed for [u8; N] {
