...
pub type M2 = Prod<Money, Money>; // 26, 6   in table
pub type M4 = Prod<M2, M2>; // 52, 12  in table
pub type M8 = Prod<M4, M4>; // 104, 24 the table stops at 64
pub const SZ: usize = core::mem::size_of::<M8>();
