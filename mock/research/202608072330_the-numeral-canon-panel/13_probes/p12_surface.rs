...
pub struct Numeral<I, F, Sign, S>(
    Container<Sum<I, F>>,
    core::marker::PhantomData<(I, F, Sign, S)>,
);

// ---- the surface the consumer writes ----
...
// ---- the bridge rows, one impl per literal ----
impl Lit for L<0> {
    type N = N0;
}
impl Lit for L<1> {
