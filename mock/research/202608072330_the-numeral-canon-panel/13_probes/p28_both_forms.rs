...
// ---- D bolted alongside B, same crate ----
pub trait IsLe {}
impl IsLe for Lt {}
impl IsLe for Eqq {}
...
// the computed form, one octave, inside the table
pub type P1 = Prod<Money, Money>;

// the declared form, at a width the computed form cannot reach on its own,
// because 52 + 52 = 104 has no reverse-table row
pub type Half = UFixed<52, 12>;
fn _declared_past_the_reverse_table()
where
    Half: MulInto<Half, UFixed<64, 24>>,
{
}
