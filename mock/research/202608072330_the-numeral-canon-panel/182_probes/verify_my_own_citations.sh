...
echo "rows across both files this pass wrote: $(grep -c '^\[\[proposal\]\]' mock/registry/proposal.toml) + $(grep -c '^\[\[law\]\]' mock/registry/law.toml) = $(( $(grep -c '^\[\[proposal\]\]' mock/registry/proposal.toml) + $(grep -c '^\[\[law\]\]' mock/registry/law.toml) ))   (182 section 13 says 88)"
echo "predicate entries summed: $(grep -hcE '^  "[a-z_]+: ' mock/registry/proposal.toml mock/registry/law.toml | paste -sd+ - | bc)   (182 section 2 says 282)"
