...
// 6. does precision agreement survive under a GENERIC parameter, where 128 and
//    129 found `I + F` and `F + I` to be distinct types?
...
pub fn generic_cross<const I: u32, const F: u32, G: Sign, S>(
    a: Fixed<I, F, G, S>,
    b: Fixed<F, I, G, S>, // the flipped coordinates
) {
    same_precision(a, b);
}
