...
/// The ablation lives in its own file, per the 500-line smell rule: it is a
/// second gcd that exists only to decompose the measured win, and it shares
/// the tower above rather than extending it.
#[path = "vu_gcd_maxmin.rs"]
pub mod maxmin;
