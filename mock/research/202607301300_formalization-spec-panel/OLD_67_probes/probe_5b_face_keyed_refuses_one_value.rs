...
// Probe 5b. A fact keyed on the FACE, given two faces that denote the SAME
// value. This refuses, and it should not: 1/3 and 2/6 are one value, so an
// operation that rejects the pair is stating something false about the numbers.
//
// This is the concrete cost of keying a value-fact on the face layer, and it is
// the reason the answer to "should two call sites resolve to the same face" is
// that the question is asking about the wrong layer.
//
