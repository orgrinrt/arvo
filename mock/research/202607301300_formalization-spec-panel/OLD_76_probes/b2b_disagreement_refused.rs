//! B2b. NEGATIVE CONTROL for B2: a `Slot` whose declared array length lies
//! about its carrier's value. If the agreement check is real, this refuses at
//! the door; if it is decorative, a 13-count reads through a 12-slot array.
//!
...
pub type C13 = Slot<Pz<I<O<I<H>>>>, 12>;
