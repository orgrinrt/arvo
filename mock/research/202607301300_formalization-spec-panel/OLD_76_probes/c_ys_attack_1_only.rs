//! C1. Attack 1 only, isolated: the forged affirmative witness on a purely
//! fractional numeral. Attack 2 aborts the build on its own, which would mask
//! whether this one is caught.
//!
