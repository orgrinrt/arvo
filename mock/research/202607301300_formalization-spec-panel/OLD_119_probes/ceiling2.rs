...
#[diagnostic::on_unimplemented(
    message = "the total width I + F is outside the widths arvo admits",
    label = "total width out of range",
    note = "arvo admits total widths 0 through 63; the sum of the integer and fraction widths must lie in that range"
)]
