...
/// implicit exponent.
pub struct FixedNumeral<P: Nat>(PhantomData<P>);
impl<P: Nat> Numeral for FixedNumeral<P> {
    type Precision = P;
...
pub fn bad() {
    let _: <Warm as Lowering<FormOf<FixedNumeral<SumOf<13, 3>>>>>::StoredWidth = Minimum;
}
