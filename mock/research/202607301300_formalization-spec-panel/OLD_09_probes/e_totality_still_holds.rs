...
const impl Resolve for StochasticRound {
    fn phi(x: i32, _min: i32, _max: i32) -> Rec {
        Rec::At(x)
    }
}
impl Resolution for StochasticRound {
    // deliberately missing all three associated types
}
