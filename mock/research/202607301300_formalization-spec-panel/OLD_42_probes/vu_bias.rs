//! Copy of 41_probes/vu_bias.rs verbatim, the UNSEALED base state the
//! attack in probe 2 runs against. vu_bias_sealed.rs in this directory
//! retargets it at the sealed nat module, the fix probe 3 verifies.
