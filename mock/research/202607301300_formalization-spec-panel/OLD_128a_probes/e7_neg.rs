...
const _: () = assert!(<PrecisionOf<1000, 1024> as Nat>::VAL == 2024);
...
const _: () = assert!(<PrecisionOf<1005, 1059> as Nat>::VAL == 2065);
...
const _: () = assert!(<PrecisionOf<1013, 1051> as Nat>::VAL == 2065);
...
const _: () = assert!(<PrecisionOf<1021, 1043> as Nat>::VAL == 2065);
...
const _: () = assert!(<PrecisionOf<1029, 1035> as Nat>::VAL == 2065);
...
const _: () = assert!(<PrecisionOf<1037, 1027> as Nat>::VAL == 2065);
...
const _: () = assert!(<PrecisionOf<1045, 1019> as Nat>::VAL == 2065);
...
const _: () = assert!(<PrecisionOf<1053, 1011> as Nat>::VAL == 2065);
