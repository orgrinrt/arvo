...
fn main() {
    println!("in range   {}", adapt::<S>(Exact::on_grid(2), Dither::UNUSED));
    println!("ordinary   {}", adapt::<S>(Exact::on_grid(9), Dither::UNUSED));
    println!("i64::MAX   {}", adapt::<S>(Exact::on_grid(i64::MAX), Dither::UNUSED));
    println!("i64::MIN   {}", adapt::<S>(Exact::on_grid(i64::MIN), Dither::UNUSED));
}
