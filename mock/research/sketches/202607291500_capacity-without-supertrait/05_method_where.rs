...
// Does a method-level bound let a generic caller reach the const half?
pub fn generic_via_method<C: Capacity + ConstCapacity>() -> <C as Capacity>::Array<u8> {
    <C as Capacity>::filled(0u8)
}
