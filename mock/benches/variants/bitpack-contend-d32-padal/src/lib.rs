//! The 32-bit dense read with its widening chain attacked.
//!
//! Same region, same mask, same wrapping sum as `bitpack-contend-d32`, and the
...
use bench_bitpack_contend_shared::{column_pass, kern_d32_padal, Contend};
use mockspace_bench_core::{timed, FfiBenchCall, Routine};
use mockspace_bench_macro::bench_variant;

#[bench_variant(
    Contend,
    "bitpack-contend-d32-padal",
    sizes = [
        163841, 163844,
        41943041, 41943044,
        83886081, 83886084,
...
fn run_contend_d32_padal<const KEY: usize>(
    ...
    timed! {
        run {
            ...
            output.value = unsafe { column_pass(t, n, base, kern_d32_padal) };
        }
    }
}
