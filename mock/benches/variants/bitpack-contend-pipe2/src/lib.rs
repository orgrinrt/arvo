//! The packed decode with 2 independent accumulators.
//!
...
use bench_bitpack_contend_shared::{column_pass, kern_packed_pipe2, Contend};
use mockspace_bench_core::{timed, FfiBenchCall, Routine};
use mockspace_bench_macro::bench_variant;

#[bench_variant(
    Contend,
    "bitpack-contend-pipe2",
    sizes = [
        163841, 163844,
        41943041, 41943044,
        83886081, 83886084,
...
fn run_contend_pipe2<const KEY: usize>(
    ...
    timed! {
        run {
            ...
            output.value = unsafe { column_pass(t, n, base, kern_packed_pipe2) };
        }
    }
}
