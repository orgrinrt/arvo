...
pub const trait ScalarEuclidRaw<const N: u16>: [const] BitsContainerFor<N, Signed> { // lint:allow(no-bare-numeric) reason: const-generic width carrier mirrors IArith<const N: u16>; tracked: #256
    /// Euclidean quotient of the raw container by an integer count (ULP granularity).
    fn div_euclid_scalar(a: <Self as BitsContainerFor<N, Signed>>::T, n: usize) -> <Self as BitsContainerFor<N, Signed>>::T; // lint:allow(no-bare-numeric) reason: divisor count carrier; tracked: #256
    /// Euclidean remainder of the raw container by an integer count (non-negative, < n).
    fn rem_euclid_scalar(a: <Self as BitsContainerFor<N, Signed>>::T, n: usize) -> <Self as BitsContainerFor<N, Signed>>::T; // lint:allow(no-bare-numeric) reason: divisor count carrier; tracked: #256
    /// `(base, base + 1 ULP, remainder as a share count)` for an even split into `n` parts.
    fn even_split_parts(a: <Self as BitsContainerFor<N, Signed>>::T, n: usize) -> (<Self as BitsContainerFor<N, Signed>>::T, <Self as BitsContainerFor<N, Signed>>::T, usize); // lint:allow(no-bare-numeric) reason: divisor count + remainder share-count carriers; tracked: #256
    /// Whole-unit euclidean quotient by a fixed-point divisor (`FRAC` fractional bits), floored to units.
    fn div_euclid_whole<const FRAC: u16>(a: <Self as BitsContainerFor<N, Signed>>::T, b: <Self as BitsContainerFor<N, Signed>>::T) -> <Self as BitsContainerFor<N, Signed>>::T; // lint:allow(no-bare-numeric) reason: const-generic FRAC carrier mirrors i_div_fixed; tracked: #256
    /// Whole-unit euclidean remainder by a fixed-point divisor (the fixed-point leftover).
    fn rem_euclid_whole<const FRAC: u16>(a: <Self as BitsContainerFor<N, Signed>>::T, b: <Self as BitsContainerFor<N, Signed>>::T) -> <Self as BitsContainerFor<N, Signed>>::T; // lint:allow(no-bare-numeric) reason: const-generic FRAC carrier; tracked: #256
}
        ...
        $(
            impl const ScalarEuclidRaw<$bits> for $strategy {
                ...
                fn rem_euclid_scalar(a: <Self as BitsContainerFor<$bits, Signed>>::T, n: usize) -> <Self as BitsContainerFor<$bits, Signed>>::T { // lint:allow(no-bare-numeric) reason: divisor count carrier; tracked: #256
                    if n == 0 { <<Self as BitsContainerFor<$bits, Signed>>::T as Identity>::ZERO } else { a.rem_euclid(n as $container) }
                }
                #[inline(always)]
                ...
                fn div_euclid_whole<const FRAC: u16>(a: <Self as BitsContainerFor<$bits, Signed>>::T, b: <Self as BitsContainerFor<$bits, Signed>>::T) -> <Self as BitsContainerFor<$bits, Signed>>::T { // lint:allow(no-bare-numeric) reason: const-generic FRAC carrier mirrors i_div_fixed; tracked: #256
                    if b == <<Self as BitsContainerFor<$bits, Signed>>::T as Identity>::ZERO { a } else { a.div_euclid(b).saturating_mul((1 as $container) << FRAC) }
                }
                #[inline(always)]
                fn rem_euclid_whole<const FRAC: u16>(a: <Self as BitsContainerFor<$bits, Signed>>::T, b: <Self as BitsContainerFor<$bits, Signed>>::T) -> <Self as BitsContainerFor<$bits, Signed>>::T { // lint:allow(no-bare-numeric) reason: const-generic FRAC carrier; tracked: #256
                    if b == <<Self as BitsContainerFor<$bits, Signed>>::T as Identity>::ZERO { <<Self as BitsContainerFor<$bits, Signed>>::T as Identity>::ZERO } else { a.rem_euclid(b) }
                }
            }
        )+
    };
...
pub const trait UScalarEuclidRaw<const N: u16>: [const] BitsContainerFor<N, Unsigned> { // lint:allow(no-bare-numeric) reason: const-generic width carrier mirrors UArith<const N: u16>; tracked: #256
    /// Euclidean quotient of the raw container by an integer count (ULP granularity).
    fn div_euclid_scalar(a: <Self as BitsContainerFor<N, Unsigned>>::T, n: usize) -> <Self as BitsContainerFor<N, Unsigned>>::T; // lint:allow(no-bare-numeric) reason: divisor count carrier; tracked: #256
    /// Euclidean remainder of the raw container by an integer count.
    fn rem_euclid_scalar(a: <Self as BitsContainerFor<N, Unsigned>>::T, n: usize) -> <Self as BitsContainerFor<N, Unsigned>>::T; // lint:allow(no-bare-numeric) reason: divisor count carrier; tracked: #256
    /// `(base, base + 1 ULP, remainder as a share count)` for an even split into `n` parts.
    fn even_split_parts(a: <Self as BitsContainerFor<N, Unsigned>>::T, n: usize) -> (<Self as BitsContainerFor<N, Unsigned>>::T, <Self as BitsContainerFor<N, Unsigned>>::T, usize); // lint:allow(no-bare-numeric) reason: divisor count + remainder share-count carriers; tracked: #256
    /// Whole-unit euclidean quotient by a fixed-point divisor (`FRAC` fractional bits), floored to units.
    fn div_euclid_whole<const FRAC: u16>(a: <Self as BitsContainerFor<N, Unsigned>>::T, b: <Self as BitsContainerFor<N, Unsigned>>::T) -> <Self as BitsContainerFor<N, Unsigned>>::T; // lint:allow(no-bare-numeric) reason: const-generic FRAC carrier mirrors u_div_fixed; tracked: #256
    /// Whole-unit euclidean remainder by a fixed-point divisor (the fixed-point leftover).
    fn rem_euclid_whole<const FRAC: u16>(a: <Self as BitsContainerFor<N, Unsigned>>::T, b: <Self as BitsContainerFor<N, Unsigned>>::T) -> <Self as BitsContainerFor<N, Unsigned>>::T; // lint:allow(no-bare-numeric) reason: const-generic FRAC carrier; tracked: #256
}
        ...
        $(
            impl const UScalarEuclidRaw<$bits> for $strategy {
                ...
                fn rem_euclid_scalar(a: <Self as BitsContainerFor<$bits, Unsigned>>::T, n: usize) -> <Self as BitsContainerFor<$bits, Unsigned>>::T { // lint:allow(no-bare-numeric) reason: divisor count carrier; tracked: #256
                    if n == 0 { <<Self as BitsContainerFor<$bits, Unsigned>>::T as Identity>::ZERO } else { a.rem_euclid(n as $container) }
                }
                #[inline(always)]
                ...
                fn div_euclid_whole<const FRAC: u16>(a: <Self as BitsContainerFor<$bits, Unsigned>>::T, b: <Self as BitsContainerFor<$bits, Unsigned>>::T) -> <Self as BitsContainerFor<$bits, Unsigned>>::T { // lint:allow(no-bare-numeric) reason: const-generic FRAC carrier mirrors u_div_fixed; tracked: #256
                    if b == <<Self as BitsContainerFor<$bits, Unsigned>>::T as Identity>::ZERO { a } else { a.div_euclid(b).saturating_mul((1 as $container) << FRAC) }
                }
                #[inline(always)]
                fn rem_euclid_whole<const FRAC: u16>(a: <Self as BitsContainerFor<$bits, Unsigned>>::T, b: <Self as BitsContainerFor<$bits, Unsigned>>::T) -> <Self as BitsContainerFor<$bits, Unsigned>>::T { // lint:allow(no-bare-numeric) reason: const-generic FRAC carrier; tracked: #256
                    if b == <<Self as BitsContainerFor<$bits, Unsigned>>::T as Identity>::ZERO { <<Self as BitsContainerFor<$bits, Unsigned>>::T as Identity>::ZERO } else { a.rem_euclid(b) }
                }
            }
        )+
    };
