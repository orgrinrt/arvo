...
fn new_nnz_zero_is_empty() {
    ...
    let csr: Csr<Dim<4>, Dim<0>, u32> = Csr::new();
    for r in 0..4 {
...
fn empty_rows_via_explicit_offsets() {
    ...
    let mut csr: Csr<Dim<3>, Dim<4>, u32> = Csr::new();
...
fn round_trip_values() {
    ...
    let mut csr: Csr<Dim<3>, Dim<6>, u32> = Csr::new();
...
#[test]
fn row_slice_views() {
    let mut csr: Csr<Dim<2>, Dim<4>, u16> = Csr::new();
...
fn out_of_range_row_is_empty() {
    let csr: Csr<Dim<2>, Dim<4>, u16> = Csr::new();
